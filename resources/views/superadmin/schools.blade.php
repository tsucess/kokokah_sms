            ...
            @for ($i = 0; $i < 9; $i++)
                ...
                <div class="bg-white rounded-2xl border border-school-btn p-6">
                    ...
                    <div
                        ...
                        <button class="block w-full text-left px-4 py-2 text-body5 font-sitka text-primary flex items-center gap-2 hover:bg-gray-100"> <i class="fa-regular fa-eye"></i>View School</button>
                        <button class="block w-full text-left px-4 py-2 text-body5 font-sitka flex items-center gap-2 text-red-600 hover:bg-red-50"><i class="fa-solid fa-trash"></i>Delete
                            School</button>
                    </div>
                    </div>
