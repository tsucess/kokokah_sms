    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div class="bg-white rounded-lg border border-gray-200 py-6 px-4">
            <div class="flex items-center justify-between mb-3">
                <p class="text-sm font-medium font-fredoka text-primary">Total Schools</p>
        ...
        <div class="bg-white rounded-lg border border-gray-200 py-6 px-4">
            <div class="flex items-center justify-between mb-3">
                <p class="text-sm font-medium text-primary font-fredoka">Total Students Across Platform</p>
                <svg class="w-5 h-5 text-black" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="bg-white rounded-lg border border-gray-200 py-6 px-4">
            <div class="flex items-center justify-between mb-3">
                <p class="text-sm font-medium text-primary font-fredoka">Monthly Revenue</p>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-5 gap-x-6">
        ...
        <div class="bg-white rounded-lg border border-gray-200 py-6 px-4 lg:col-span-2 ">
            <div class="flex items-center justify-between mb-4 lg:mb-8">
                <div>
                    <h2 class="text-body4 font-semibold text-black font-inter">School Types (Distribution by institution type)</h2>
                </div>
            </div>
