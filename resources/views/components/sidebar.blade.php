...
<aside class="w-64 bg-white border-r border-gray-200 min-h-screen flex flex-col font-fredoka">
    ...
    <nav class="flex-1 px-4 space-y-1">
        ...
        <a href="{{ route('superadmin.analytics') }}"
           class="flex items-center px-4 py-3 text-sm font-fredoka font-medium rounded-lg transition-colors {{ $active === 'analytics' ? 'text-gray-900' : 'text-gray-700 hover:bg-gray-100' }}" style="{{ $active === 'analytics' ? 'background-color: #FDAF22;' : '' }}">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="{{ route('superadmin.subscription') }}"
           class="flex items-center px-4 py-3 text-sm font-fredoka font-medium rounded-lg transition-colors {{ $active === 'subscription' ? 'text-gray-900' : 'text-gray-700 hover:bg-gray-100' }}" style="{{ $active === 'subscription' ? 'background-color: #FDAF22;' : '' }}">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="{{ route('superadmin.communication') }}"
           class="flex items-center px-4 py-3 text-sm font-fredoka font-medium rounded-lg transition-colors {{ $active === 'communication' ? 'text-gray-900' : 'text-gray-700 hover:bg-gray-100' }}" style="{{ $active === 'communication' ? 'background-color: #FDAF22;' : '' }}">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="{{ route('superadmin.modules') }}"
           class="flex items-center px-4 py-3 text-sm font-fredoka font-medium rounded-lg transition-colors {{ $active === 'modules' ? 'text-gray-900' : 'text-gray-700 hover:bg-gray-100' }}" style="{{ $active === 'modules' ? 'background-color: #FDAF22;' : '' }}">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="p-4 border-t border-gray-200">
        <div class="flex items-center">
            ...
            <div class="ml-3 flex-1">
                <p class="text-sm font-fredoka font-medium text-gray-900">Culaccino_</p>
                <p class="text-xs font-fredoka text-gray-500">SA Designer</p>
            </div>
    ...
    <!-- Settings -->
    <div class="px-4 pb-4">
        <a href="{{ route('superadmin.settings') }}" class="flex items-center px-4 py-3 text-sm font-fredoka font-medium text-gray-700 hover:bg-gray-100 rounded-lg transition-colors">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
