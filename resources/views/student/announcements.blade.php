@extends('layouts.student', ['active' => 'announcements'])
    ...
    <div class="p-4 md:p-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            ...
            <div class="bg-white rounded-lg border border-school-btn p-4 md:p-6">
                <div class="flex items-start gap-4">
                    <div class="w-9 h-9 md:w-12 md:h-12 rounded-lg flex items-center justify-center bg-messageBg shrink-0">
                        <svg class="w-6 h-6" style="color: #3D5EE1;" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="flex-1 gap-4">
                        ...
                        <p class="text-xl md:text-3xl font-bold font-fredoka text-primary">1,234</p>
                    </div>
            ...
            <div class="bg-white rounded-lg border border-school-btn p-4 md:p-6">
                <div class="flex items-start gap-4">
                    ...
                    <div class="flex-1 gap-4">
                        ...
                        <p class="text-xl md:text-3xl font-bold font-fredoka text-primary">34</p>
                    </div>
            ...
            <div class="bg-white rounded-lg border border-school-btn p-4 md:p-6">
                <div class="flex items-start gap-4">
                    ...
                    <div class="flex-1 gap-4">
                        ...
                        <p class="text-xl md:text-3xl font-bold font-fredoka text-primary">234</p>
                    </div>
            ...
            <div class="bg-white rounded-lg border border-school-btn p-4 md:p-6">
                <div class="flex items-start gap-4">
                    <div class="w-9 h-9 md:w-12 md:h-12 rounded-lg flex items-center justify-center bg-annoucementBg shrink-0">
                    ...
                    <div class="flex-1 gap-4">
                        ...
                        <p class="text-xl md:text-3xl font-bold font-fredoka text-primary">3</p>
                    </div>
            ...
            <nav class="flex">
                <div class="flex">
                    <button onclick="showTab('messages')" id="tab-messages"
                        class="px-3 md:px-6 py-2 text-sm rounded-l-lg font-fredoka border border-primary text-primary bg-white hover:bg-gray-200 transition-colors">
                        Messages
                    </button>
                    <button onclick="showTab('inbox')" id="tab-inbox"
                        class="px-3 md:px-6 py-2 text-sm font-fredoka border border-primary text-primary bg-white hover:bg-gray-200 transition-colors">
                        Inbox
                    </button>
                    ...
                    <button onclick="showTab('announcements')" id="tab-announcements"
                        class="px-3 md:px-6 py-2 text-sm font-fredoka border border-primary text-primary rounded-r-lg bg-white hover:bg-gray-200 transition-colors">
                        Announcement
                    </button>
            </nav>
        </div>
        ...
        <div id="content-announcements" class="tab-content menu-hidden">
            <div class="bg-white rounded-lg border border-school-btn p-6">
                ...
                <div class="space-y-4">
                    <!-- Announcement 1 -->
                    <div class="border border-school-btn rounded-lg p-4 space-y-5 hover:bg-gray-50 cursor-pointer">
                        ...
                        <div class="flex flex-col gap-5">
                                ...
                                <div class="flex flex-col gap-3 md:flex-row justify-between md:items-center">
                                    <div class="flex flex-col gap-1 md:flex-row justify-between md:items-center">
                                        ...
                                        <div class="flex items-center gap-2">
                                            <span
                                                class="px-2 py-1 text-xs rounded font-fredoka grayed-btn">Medium</span>
                                            <span
                                                class="px-2 py-1 text-xs rounded font-fredoka bordered-btn">General</span>
                                            <span
                                                class="px-2 py-1 text-xs rounded font-fredoka dark-btn">Published</span>
                                        </div>
                                    </div>
                                    <div class="flex items-center space-x-1">
                                        <button class="p-2 hover:bg-gray-100 rounded">
                            ...
                            <div class="flex items-center text-[10px] md:text-xs text-primary space-x-1 md:space-x-3">
