...
<style>
    ...
    <div class="p-4 md:px-8 space-y-6">
        <header
            ...
            <img src="/images/cap.png" alt="" class="absolute right-20 md:right-50 w-20 md:w-40 top-4">
            <img src="/images/College Student.png" alt="" class="absolute bottom-0 right-2 md:right-20 w-30 md:w-45">
            <img src="/images/backpack.png" alt="" class="absolute right-0 md:right-6  md:top-10 w-10 md:w-26">
        </header>
