...
<div class="p-8">
    ...
    <div class="mb-6 flex items-center justify-between">
        <div class="border-b border-gray-200">
            <nav class="flex space-x-8">
                ...
                <a href="{{ route('admin.students.profile-documents') }}" class="text-gray-500 hover:text-gray-700 py-4 px-1 border-b-2 border-transparent font-medium text-sm">
                    Documents
                </a>
            </nav>
        </div>
    ...
    <div class="grid grid-cols-5 gap-6">
        <div class="bg-white rounded-lg border-l-4 border-blue-500 p-6">
            <p class="text-2xl font-bold text-teal-900 mb-2">₦100,247</p>
            <p class="text-sm text-gray-600">Student Bill</p>
        </div>
        ...
        <div class="bg-white rounded-lg border-l-4 border-green-500 p-6">
            <p class="text-2xl font-bold text-teal-900 mb-2">₦100,247</p>
            <p class="text-sm text-gray-600">Amount Expected</p>
        </div>
        <div class="bg-white rounded-lg border-l-4 border-gray-400 p-6">
            <p class="text-2xl font-bold text-teal-900 mb-2">₦100,247</p>
            <p class="text-sm text-gray-600">Amount Paid</p>
        </div>
        <div class="bg-white rounded-lg border-l-4 border-orange-500 p-6">
            <p class="text-2xl font-bold text-teal-900 mb-2">₦100,247</p>
